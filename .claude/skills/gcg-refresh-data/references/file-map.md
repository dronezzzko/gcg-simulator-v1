...
| New or changed card behaviour | `src/gcg_sim/effects/bindings/<package>.py` (`<package>` = the work-package id in snake case, e.g. `wp_gd06_a` for WP-GD06-A) or the compiler (`src/gcg_sim/effects/compiler/`) | `card-checklist.md` |
